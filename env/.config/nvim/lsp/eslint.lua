...
return {
  ...
  -- -- the `LspEslintFixAll` command can be used to format a document on save:
  -- -- I will use Prettier instead
      ...
      --     client:request_sync('workspace/executeCommand', {
        ...
        --       arguments = {
          --         {
            ...
            -- Refer to https://github.com/Microsoft/vscode-eslint#settings-options for documentation.--ian-fix
            settings = {
              debug = false,
              validate = 'on',
              packageManager = nil,--ian-fix
              useESLintClass = true,
              experimental = {--ian-fix
                useFlatConfig = true
              },
              codeActionOnSave = {
                enable = false,
              ...
              workingDirectory = { mode = 'auto' },--ian-fix
              codeAction = {
                disableRuleComment = {
                  enable = true,
